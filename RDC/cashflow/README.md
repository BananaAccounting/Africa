...
* Install the BananaApp **Cash Flow Report (OHADA - RDC)** for the cash flow report only, or the BananaApp **Accounting Reports (OHADA - RDC)** for the Balance Sheet, Profit/Loss Statement and Cash Flow package reports.
. Visit the [Menu Apps](https://www.banana.ch/doc9/en/node/4727) documentation.
